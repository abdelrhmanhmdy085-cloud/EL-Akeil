...
function initLanguage() {
    ...
    if (nav) {
        nav.innerHTML = `
            <button type="button" class="lang-toggle-btn" onclick="toggleLanguage()" title="Switch Language" data-i18n-title="lang_switch_tooltip" data-i18n-aria-label="aria_label_lang_toggle">
