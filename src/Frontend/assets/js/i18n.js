...
function initLanguage() {
    ...
    if (nav && !nav.querySelector('.lang-toggle-btn')) {
        ...
        const btnHtml = `
            <button class="lang-toggle-btn" onclick="toggleLanguage()" title="Switch Language" data-i18n-aria-label="aria_label_lang_toggle" aria-label="Switch Language">
