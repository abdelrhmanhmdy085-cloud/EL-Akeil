...
function initLanguage() {
    ...
    if (nav) {
        nav.innerHTML = `
            <button type="button" class="lang-toggle-btn" onclick="toggleLanguage()" data-i18n-title="lang_toggle_title" data-i18n-aria-label="aria_label_lang_toggle" title="Switch Language" aria-label="Switch Language">
