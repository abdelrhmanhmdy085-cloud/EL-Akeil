...
function initLanguage() {
    ...
    if (nav && !document.querySelector('.lang-toggle-btn')) {
        const toggleBtn = document.createElement('button');
        toggleBtn.type = 'button';
        toggleBtn.className = 'lang-toggle-btn';
        toggleBtn.onclick = toggleLanguage;
        toggleBtn.setAttribute('data-i18n-aria-label', 'aria_label_lang_toggle');
        toggleBtn.setAttribute('data-i18n-title', 'aria_label_lang_toggle');
