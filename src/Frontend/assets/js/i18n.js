...
function initLanguage() {
    ...
    if (nav) {
        nav.prepend(Object.assign(document.createElement('button'), {
            className: 'lang-toggle-btn',
            onclick: toggleLanguage,
            title: 'Switch Language',
            innerHTML: `🌍 <span id="lang-label">${saved === 'ar' ? 'EN' : 'AR'}</span>`
        }));
        nav.querySelector('.lang-toggle-btn').setAttribute('data-i18n-aria-label', 'aria_label_lang_toggle');
    }
